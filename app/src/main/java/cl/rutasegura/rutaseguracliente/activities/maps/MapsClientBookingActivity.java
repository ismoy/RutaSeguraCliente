...
public class MapsClientBookingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_client_booking);

        mAuthProvider = new AuthProvider();
        mGeofireProvider = new GeofireProvider("drivers_working");
        mTokenProvider = new TokenProvider();
        mClientBookingProvider = new ClientBookingProvider();
        mGoogleApiProvider = new GoogleApiProvider(MapsClientBookingActivity.this);
    ...
    private void finishBooking() {
        ...
        Intent intent = new Intent(MapsClientBookingActivity.this, CalificationDriverActivity.class);
    ...
    private void startBooking() {
       ...
       if (mDriverLatLng !=null){
           mMarkerDriver = mMap.addMarker(new MarkerOptions()
                   .position(new LatLng(mDriverLatLng.latitude, mDriverLatLng.latitude))
                   .title("Tu conductor")
