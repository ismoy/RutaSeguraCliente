package cl.rutasegura.rutaseguracliente.services;
...
import cl.rutasegura.rutaseguracliente.channel.NotificationHelper;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (title != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                if (title.contains("RUTASEGURA CANCELADO")) {
